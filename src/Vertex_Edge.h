...
protected:
    std::string Name; /** @brief Name of the vertex.*/
    std::string District; /** @brief District of the vertex.*/
    std::string Municipaly; /** @brief Municipality of the vertex.*/
    std::string Township; /** @brief Township of the vertex.*/
    std::string Line; /** @brief Line of the vertex.*/

    double cost = 0;  /** @brief Cost associated with the vertex.*/
    double INC_capacity = 0; /** @brief Incoming capacity of the vertex*/
    double OUT_capacity = 0; /** @brief Outgoing capacity of the vertex.*/
    double id;                /** @brief  Identifier of the vertex.*/
    std::vector<Edge *> adj;  /** @brief Outgoing edges from the vertex.*/

    // auxiliary fields
    bool visited = false; /** @brief Visited status of the vertex, used by DFS, BFS, Prim, etc.*/
    bool processing = false; /** @brief Processing status of the vertex, used by isDAG (in addition to the visited attribute).*/
    unsigned int indegree; /** @brief Indegree of the vertex, used by topsort.*/
    double dist = INF; /** @brief Distance of the vertex from a source vertex in a graph traversal algorithm.*/
    Edge *path = nullptr; /** @brief Path of the vertex in a graph traversal algorithm.*/
